    ...
    <div id="dashboard" className="z-[100]">
      <section className="bg-dark_primary py-5 text-white">
        <div className="w-[90%] md:w-[80%] mx-auto">
          ...
          <h4 className="subtitle font-bold text-md mt-4 text-left text-white" data-aos="fade-down">
            Dashboard
          </h4>
          ...
          <div className="flex flex-col">
            ...
            <div id="gallery" className={``}>
              ...
              <h1 className="font-bold text-3xl text-center lg:text-left lg:text-4xl ">MY PORTFOLIO</h1>
